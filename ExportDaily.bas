...
Public Const superFinch = "S:\Productions\supervisor-Finch.xls"
...
Sub ExportDailyCopy()
    ...
    rootPath = "S:\Productions\ReportNetWorks"
    currentDate = Format(Date - 1, "yyyy-mm-dd")
    
    ' S:\Productions\ReportNetWorks\yyyy Prod Report\yyyy-mm-dd Production Line Status - Daily Printed.xlsx
